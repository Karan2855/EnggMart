...
import com.example.user.enggmart.activities.PDFViewActivity;
import com.example.user.enggmart.models.ModelCurrentAffairs;
import com.example.user.enggmart.models.ModelNovels;
...
public class NovelsAdapter extends RecyclerView.Adapter<NovelsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final NovelsAdapter.MyViewHolder holder, final int position) {
        ...
        Glide.with(getApplicationContext()).load(modelNovels.getItemImage() + "").into(holder.itemImage);
